...
ds.to_zarr(store='/store/albert7a/NATL60/NATL60-CJM165-S/1h/surf-U-V/zarr/NATL60-CJM165-SSV-1h-1m2deg2deg', encoding=encoding)
zrtot=zarr.open('/store/albert7a/NATL60/NATL60-CJM165-S/1h/surf-U-V/zarr/NATL60-CJM165-SSV-1h-1m2deg2deg',mode='a')
...
for m in np.arange(12,13):
	...
	ds.to_zarr(store='/store/albert7a/NATL60/NATL60-CJM165-S/1h/surf-U-V/zarr/zarr_SSV_2012m'+str(m)+'-1m2deg2deg', encoding=encoding)
	zr=zarr.open('/store/albert7a/NATL60/NATL60-CJM165-S/1h/surf-U-V/zarr/zarr_SSV_2012m'+str(m)+'-1m2deg2deg',mode='r')
...
for m in np.arange(1,10):
        ...
        ds.to_zarr(store='/store/albert7a/NATL60/NATL60-CJM165-S/1h/surf-U-V/zarr/zarr_SSV_2013m0'+str(m)+'-1m2deg2deg', encoding=encoding)
        zr=zarr.open('/store/albert7a/NATL60/NATL60-CJM165-S/1h/surf-U-V/zarr/zarr_SSV_2013m0'+str(m)+'-1m2deg2deg',mode='r')
        for key in [k for k in zr.array_keys() if k not in ['nav_lat','nav_lon']]:
                zrtot[key].append(zr[key])
        print('ending month ',str(m))

name='/store/albert7a/NATL60/NATL60-CJM165-S/1h/surf-U-V/zarr/NATL60-CJM165-SSV-1h-1m2deg2deg'
...
!cp -r /scratch/cnt0024/hmg2840/albert7a/NATL60/NATL60-CJM165-S/1h/SSH/zarr_time/time_counter /store/albert7a/NATL60/NATL60-CJM165-S/1h/surf-U-V/zarr/NATL60-CJM165-SSV-1h-1m2deg2deg/


ds_z = xr.open_zarr('/store/albert7a/NATL60/NATL60-CJM165-S/1h/surf-U-V/zarr/NATL60-CJM165-SSV-1h-1m2deg2deg')
ds_z
